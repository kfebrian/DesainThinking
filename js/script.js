     ...
     function initTabMap() {
        ...
        var mapOptions1 = {
          ...
          center: new google.maps.LatLng(-7.642410188340485, 110.42934290792967), // Providence, RI
        ...
        var marker1 = new google.maps.Marker({
          position: new google.maps.LatLng(-7.642410188340485, 110.42934290792967),
          map: map1,
      ...
      function init() {
        ...
        var mapOptions = {
          ...
          // The latitude and longitude to center the map (always required)
          center: new google.maps.LatLng(-7.642410188340485, 110.42934290792967), // New York
